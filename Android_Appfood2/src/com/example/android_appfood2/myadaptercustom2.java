...
public class myadaptercustom2 extends ArrayAdapter<foody>{
	//CheckBox check;
	 ...
	 Context context;
	// boolean check1;
	  public myadaptercustom2(Context context, int textViewResourceId, List<foody> objects) {
      ...
      public View getView(int position, View convertView, ViewGroup parent) {
		...
		person = getItem(position);
             ...
             if (convertView == null) {
                    convertView = LayoutInflater.from(getContext()).inflate(
                                          R.layout.itemcustom2, parent, false);
             }
        ...
        //     ImageView img1=(ImageView) convertView.findViewById(R.id.imageView2);
    		...
    		//  img.setImageBitmap(person.getHinhanh());
    		  ...
    		  Picasso.with(context).load(person.getTesthinhanh()).resize(80, 50).into(img);

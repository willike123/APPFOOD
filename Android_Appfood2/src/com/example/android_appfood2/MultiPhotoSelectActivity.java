...
public class MultiPhotoSelectActivity extends BaseActivity {
	...
	//	bb.putString("phone12", phone);
		i.putStringArrayListExtra("fileanh", selectedItems);
		setResult(RESULT_OK,i);
		finish();
		
	//	Toast.makeText(MultiPhotoSelectActivity.this, "Total photos selected: "+selectedItems.get(1).toString(), Toast.LENGTH_SHORT).show();
